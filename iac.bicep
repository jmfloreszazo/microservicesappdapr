// Step 1: az login
// Step 2: az group create --name [myResourceGroup] --location "Central US"

param location string = resourceGroup().location
param namespaceName string

var serviceBusNamespaceName = concat(namespaceName, '-daprsample')
...
resource container 'Microsoft.Storage/storageAccounts/blobServices/containers@2019-06-01' = {
  name: '${sa.name}/default/daprsample'
}
